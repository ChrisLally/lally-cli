import { addDbLocalPostgres } from "./local-postgres";
import { addDbMasterMigration } from "./master-migration";
import { addDbSeedScript } from "./seed-script";
import {
  getStringFlag,
...
/**
 * @description Scaffold database setup files for an app (local Postgres, master migration, seed script).
 */
